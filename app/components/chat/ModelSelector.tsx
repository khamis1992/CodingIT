  ...
  return (
    <div className="flex gap-2 flex-col sm:flex-row overflow-visible">
      ...
      >
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-[100] w-full mt-1 py-1 rounded-lg border border-codinit-elements-borderColor bg-codinit-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                ...
                {providerSearchQuery && (
                  <button
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 rounded hover:bg-codinit-elements-background-depth-3 transition-colors"
                    aria-label="Clear search"
                  >
                    <span className="i-ph:x text-codinit-elements-textTertiary text-xs" />
                  </button>
                )}
              </div>
            </div>
            ...
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-3 text-sm">
                  <div className="text-codinit-elements-textTertiary mb-1">
          ...
          >
            <div className="px-2 pb-2 space-y-2">
                  ...
                  <button
                    ...
                    className={classNames(
                      ...
                      showFreeModelsOnly
                        ...
                        : 'bg-codinit-elements-background-depth-3 text-codinit-elements-textSecondary border border-codinit-elements-borderColor',
                    )}
                  >
              ...
              {debouncedModelSearchQuery && filteredModels.length > 0 && (
                <div className="text-xs text-codinit-elements-textTertiary px-1">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-3 text-sm">
                  <div className="flex items-center gap-2 text-codinit-elements-textTertiary">
