      ...
      <div className="h-full">
        <div className="bg-codinit-elements-terminals-background h-full flex flex-col">
                  ...
                  {index == 0 ? (
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-codinit-elements-textTertiary hover:text-codinit-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting CodinIT.dev terminal [${index}]`);
