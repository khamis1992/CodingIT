  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-codinit-elements-background border border-codinit-elements-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-codinit-elements-textPrimary">Connect to GitHub</h2>
                <button
                  onClick={handleClose}
                  className="p-1 rounded-md hover:bg-codinit-elements-item-backgroundActive/10"
                >
                  <div className="i-ph:x w-4 h-4 text-codinit-elements-textSecondary" />
                </button>
              </div>

              <div className="text-xs text-codinit-elements-textSecondary bg-codinit-elements-background-depth-1 p-3 rounded-lg">
                <p className="flex items-center gap-1 mb-1">
                  <span className="i-ph:lightbulb w-3.5 h-3.5 text-codinit-elements-icon-success" />
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-codinit-elements-textSecondary mb-2">Token Type</label>
                  <select
                    value={tokenType}
                    ...
                    className={classNames(
                      ...
                      'focus:outline-none focus:ring-1 focus:ring-codinit-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-4 py-2 text-sm text-codinit-elements-textSecondary hover:text-codinit-elements-textPrimary"
                  >
                    Cancel
                  </button>
                  <button
