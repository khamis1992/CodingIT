          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-codinit-elements-background-depth-1 rounded-lg border border-codinit-elements-borderColor">
                <h4 className="text-sm font-medium text-codinit-elements-textPrimary mb-3">Netlify Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.totalSites}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Total Sites</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.totalDeploys || deploymentCount}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Total Deployments</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.totalBuilds || 0}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Total Builds</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {sites.filter((site) => site.published_deploy?.state === 'ready').length}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Live Sites</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-codinit-elements-textPrimary">Deployment Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg border border-codinit-elements-borderColor">
                    <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-pie w-4 h-4 text-codinit-elements-item-contentAccent" />
                      Success Rate
                    </h6>
                  ...
                  <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg border border-codinit-elements-borderColor">
                    <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:clock w-4 h-4 text-codinit-elements-item-contentAccent" />
                      Recent Activity
                    </h6>
                    <div className="space-y-1">
                      {(() => {
              ...
              {/* Site Health Metrics */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-codinit-elements-textPrimary mb-2">Site Health Overview</h4>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <div className="i-ph:buildings w-4 h-4 text-codinit-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                >
                  <div className="i-ph:rocket-launch w-4 h-4 text-codinit-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                >
                  <div className="i-ph:hammer w-4 h-4 text-codinit-elements-item-contentAccent" />
                ...
                <div className="mt-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary">
                          <div className="i-ph:buildings w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                          Your Sites ({sites.length})
                        </h4>
                        {sites.length > 8 && (
                          <button
                            onClick={() => setIsSitesExpanded(!isSitesExpanded)}
                            className="text-xs text-codinit-elements-textSecondary hover:text-codinit-elements-textPrimary transition-colors"
                          >
                      ...
                      >
                        <div
                          className={classNames(
                            'i-ph:arrows-clockwise w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {(isSitesExpanded ? sites : sites.slice(0, 8)).map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-codinit-elements-background dark:bg-codinit-elements-background-depth-1 border rounded-lg p-4 transition-all cursor-pointer',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="i-ph:cloud w-5 h-5 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                          ...
                          <div className="mt-3 space-y-2">
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <div className="i-ph:cloud w-3 h-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                <span className="underline decoration-1 underline-offset-2">
                                  {site.ssl_url || site.url}
                                </span>
                              </a>
                            </div>
                            <div className="flex items-center gap-4 text-xs text-codinit-elements-textSecondary">
                              {site.published_deploy?.framework && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:cube w-3 h-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  <span>{site.published_deploy.framework}</span>
                                </div>
                              )}
                              {site.custom_domain && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:globe w-3 h-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  <span>Custom Domain</span>
                                </div>
                              )}
                              {site.branch && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:code w-3 h-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                            ...
                            <>
                              <div className="mt-4 pt-3 border-t border-codinit-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    ...
                                    >
                                      <div
                                        className={`${action.icon} w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent`}
                                      />
                                      {action.name}
                                    </Button>
                                  ))}
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <div className="i-ph:clock w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  ...
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <div className="i-ph:code w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                      <span className="text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-closed w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-open w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                  ...
                  {connection.stats.builds && connection.stats.builds.length > 0 && (
                    <div className="bg-codinit-elements-background dark:bg-codinit-elements-background-depth-1 border border-codinit-elements-borderColor dark:border-codinit-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary">
                          <div className="i-ph:hammer w-4 h-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
