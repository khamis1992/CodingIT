        ...
        <CollapsibleContent className="overflow-hidden">
          <div className="space-y-4 mt-4">
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 p-4 bg-codinit-elements-background-depth-1 rounded-lg border border-codinit-elements-borderColor">
                <h4 className="text-sm font-medium text-codinit-elements-textPrimary mb-3">Supabase Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.totalProjects}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Total Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status === 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Active Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p: SupabaseProject) => p.region)).size}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Regions Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-codinit-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status !== 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-codinit-elements-textSecondary">Inactive Projects</div>
                  </div>
                </div>
              </div>
            ) : null}
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project: SupabaseProject) => (
                  <div
                    key={project.id}
                    className={classNames(
                      'p-4 rounded-lg border transition-colors bg-codinit-elements-background-depth-1 cursor-pointer',
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-codinit-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:database w-4 h-4 text-codinit-elements-borderColorActive" />
                          {project.name}
                        </h5>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 pt-3 border-t border-codinit-elements-borderColor">
                          <div className="text-center">
                            <div className="text-sm font-semibold text-codinit-elements-textPrimary">
                              {project.stats?.database?.tables ?? '--'}
                            </div>
                            <div className="text-xs text-codinit-elements-textSecondary flex items-center justify-center gap-1">
                    ...
                    {selectedProjectId === project.id && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-codinit-elements-borderColor">
                        <div className="flex flex-wrap items-center gap-1">
                          {projectActions.map((action) => (
                            <Button
                              ...
                              className="flex items-center gap-1 text-xs px-2 py-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:database w-4 h-4 text-codinit-elements-item-contentAccent" />
                              Database Schema
                            </h6>
                            <div className="space-y-1 text-xs text-codinit-elements-textSecondary">
                          ...
                          <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:folder w-4 h-4 text-codinit-elements-item-contentAccent" />
                              Storage
                            </h6>
                            <div className="space-y-1 text-xs text-codinit-elements-textSecondary">
                              <div className="flex justify-between">
                        ...
                        {connection.credentials && (
                          <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:key w-4 h-4 text-codinit-elements-item-contentAccent" />
                              Project Credentials
                            </h6>
                            <div className="space-y-2">
                              <div>
                                <label className="text-xs text-codinit-elements-textSecondary">Supabase URL:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="text"
                                    value={connection.credentials.supabaseUrl || ''}
                                    readOnly
                                    className="flex-1 px-2 py-1 text-xs bg-codinit-elements-background border border-codinit-elements-borderColor rounded"
                                  />
                                  <Button
                                    size="icon"
                                    variant="outline"
                              ...
                              <div>
                                <label className="text-xs text-codinit-elements-textSecondary">Anon Key:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="password"
              ...
              <div className="text-sm text-codinit-elements-textSecondary flex items-center gap-2 p-4">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            ...
            <div className="space-y-6">
              ...
              {connection.user && (
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-codinit-elements-background-depth-1 dark:bg-codinit-elements-background-depth-1 rounded-lg">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                      <div className="i-ph:user w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-codinit-elements-textPrimary">{connection.user.email}</h4>
                  ...
                  <div className="mb-6 space-y-4">
                    <h4 className="text-sm font-medium text-codinit-elements-textPrimary">Performance Analytics</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg border border-codinit-elements-borderColor">
                        <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:chart-line w-4 h-4 text-codinit-elements-item-contentAccent" />
                          Database Health
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                            ...
                            <div key={idx} className="flex justify-between text-xs">
                              <span className="text-codinit-elements-textSecondary">{item.label}:</span>
                              <span className="text-codinit-elements-textPrimary font-medium">{item.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg border border-codinit-elements-borderColor">
                        <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:shield-check w-4 h-4 text-codinit-elements-item-contentAccent" />
                          Auth & Security
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                      ...
                      <div className="bg-codinit-elements-background-depth-2 p-3 rounded-lg border border-codinit-elements-borderColor">
                        <h6 className="text-xs font-medium text-codinit-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:globe w-4 h-4 text-codinit-elements-item-contentAccent" />
                  ...
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-codinit-elements-textPrimary mb-2">Resource Overview</h4>
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      {(() => {
                        ...
                        <div
                          key={index}
                          className={`flex flex-col p-3 rounded-lg border border-codinit-elements-borderColor ${metric.bgColor}`}
                        >
                          <div className="flex items-center gap-2 mb-1">
                            <div className={`${metric.icon} w-4 h-4 ${metric.color}`} />
                            <span className="text-xs text-codinit-elements-textSecondary">{metric.label}</span>
                          </div>
                  ...
                  {/* Usage Metrics */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-3 bg-codinit-elements-background-depth-1 rounded-lg border border-codinit-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:database w-4 h-4 text-codinit-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-codinit-elements-textPrimary">Database</span>
                      </div>
                    ...
                    <div className="p-3 bg-codinit-elements-background-depth-1 rounded-lg border border-codinit-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:folder w-4 h-4 text-codinit-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-codinit-elements-textPrimary">Storage</span>
                      </div>
                      <div className="text-sm text-codinit-elements-textSecondary">
                        <div>
                          Buckets:{' '}
                    ...
                    <div className="p-3 bg-codinit-elements-background-depth-1 rounded-lg border border-codinit-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:code w-4 h-4 text-codinit-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-codinit-elements-textPrimary">Functions</span>
                      </div>
                      <div className="text-sm text-codinit-elements-textSecondary">
                        <div>
                          Deployed:{' '}
