      ...
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[10000]">
          ...
          >
            ...
            >
              <Dialog.Title className="text-lg font-medium text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary-dark mb-4">
                Connect to GitLab
              </Dialog.Title>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-base font-medium text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary-dark">
                    GitLab Connection
                  </h3>
                  <p
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary-dark mb-2">
                    GitLab URL
                  </label>
                  <input
                    type="url"
                    ...
                    className={classNames(
                      ...
                      'placeholder-codinit-elements-textTertiary dark:placeholder-codinit-elements-textTertiary-dark',
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <div className="mt-2 text-xs text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary-dark">
                    <a
