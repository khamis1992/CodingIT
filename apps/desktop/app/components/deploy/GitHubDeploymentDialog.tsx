    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from codinit.dev' : 'Update from codinit.dev',
          tree: treeData.sha,
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
